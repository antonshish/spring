...
//from src/main/resources file are automatically copied to classpath during Maven build
@PropertySource("classpath:persistence-mysql.properties")
public class DemoAppConfig {
	
	//set up a variable to hold the properties
	@Autowired
	private Environment env; //hold data read from properties files(helper class)
